...
def hideout():
    while True:
        ...
        pos = click_btn('img/open-atk.png')

        time.sleep(1)

        if exists_btn('img/weak-warn.png'):     # se achar missao media/dificil, realiza elas, se nao vai para proxima zona
            click_btn('img/change-adv.png')
            if exists_btn('img/weak-warn.png'):
            ...
            click_btn('img/attack-ho.png')
            pyautogui.moveRel(0, -120)
            pyautogui.click()
            click_btn('img/make-bot.png', offset_y=10)
            click_btn('img/start-prod.png')
            time.sleep(360) # 6 min q é o tempo do bot ficar pronto, ai o ciclo reinicia
